...
web_link= "https://www.pap.fr/annonce/vente-appartement-maison-paris-75-g439g441g442g455g456g457g458g459"
...
for i in range(len(links)):
        d = vp.page_scrapping(links[i])
        frames.append(d)
result = pd.concat(frames)
result.to_csv("C:/Users/hp/PycharmProjects/realestate_prjt/page.csv", index=False)
